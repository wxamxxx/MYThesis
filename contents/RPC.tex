...
\subsection{Production Status and Prospects}

The upgrade of the ATLAS RPC system for the Phase-II HL-LHC
programme relies on a large-scale production effort distributed across
multiple institutions.
The China Muon team has assumed a central role in this project,
covering a substantial fraction of the production chain.
The assigned deliverables include the manufacturing of $288$ BIS
singlets together with their readout panels, $120$ BOM\&BOR singlets,
$72$ RPC gas gaps, and approximately $5000$ front-end electronics
boards, in addition to the associated low- and high-voltage power
supply systems.
The production is now well advanced, and the major technical
challenges encountered during the early phases have been successfully
addressed.

A full production chain for the thin-gap RPC gas gaps has been
established in China, incorporating automated glue and spacer
distribution, precision machining, gas-tight sealing, linseed-oil
treatment, and graphite coating.
The readout panel production has been completed for all $576$ BIS
panels, which were qualified using a dedicated automated thickness
scanning system as decirbed above.
The assembly and quality-assurance procedures for the singlet modules
were developed in close collaboration with CERN, and a first batch of
$21$ BIS singlets was successfully assembled and qualified in
July~2025.
Furthermore, a custom $288$-channel readout system with a time
resolution of $100\,\text{ps}$ has been deployed to support the
performance validation of the mass-produced detectors.

During the mass production of gas gaps at the industrial partner in
Italy, two main issues were encountered and subsequently resolved
based on the experience gained from the prototype production in China.
A gas-leak problem affecting approximately $160$ early gaps was traced
to a mechanical weak point and was eliminated through a structural
optimisation.
A drifting-current issue observed in more than half of the $\sim290$
gaps produced up to September~2025 was mitigated by several process
improvements, including pre-washing before oiling, extended drying
time, argon training, and enhanced gluing quality.
As a result of these optimisations, the most recent production batch
achieved a yield of $15$ out of $16$ accepted gaps.

The assembly and testing of the BIS singlets are being carried out
with dedicated infrastructure established for this purpose.
The necessary production line and cosmic-ray test station have been
set up, and the BIS singlet assembly is scheduled to take place in the
first half of 2026, followed by qualification tests continuing through
the remainder of the year.
Following the completion of these phases, the modules will be
transported to CERN for integration into the ATLAS muon spectrometer,
after which the team will participate in the installation and
commissioning of the new RPC system.
An overview of the production roadmap and the key milestones is
presented in Figure~\ref{fig:rpc_roadmap}.

\begin{figure}[htbp]
    \centering
    % Replace with the actual roadmap figure from the slides
    \includegraphics[width=0.9\textwidth]{figures/RPC_main/PhaseII_roadmap.png}
    \caption{
    Production roadmap and key milestones for the ATLAS RPC Phase-II
    upgrade.
    }
    \label{fig:rpc_roadmap}
\end{figure}

The successful establishment of the production chain and the resolution
of the early technical difficulties demonstrate the capability of the
distributed RPC upgrade effort to deliver high-quality detectors for
the demanding environment of the HL-LHC.
The improvements in rate capability and trigger redundancy provided by
the new thin-gap RPC system are expected to ensure robust muon
triggering throughout the high-luminosity era.
