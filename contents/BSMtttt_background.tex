...
\begin{table}[htbp]
  ...
  \begin{tabular}{c|cc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Signal-to-background ratio in the regions used to derive the flavour rescaling factors (illustrated for the BSMtttt \texorpdfstring{$m=700$~GeV}{m=700 GeV} hypothesis), prior to applying any data-driven corrections.}
...
\begin{figure}[htbp]
  ...
  \caption{Distributions of \pcbThreeFourSym{} in the 1L flavour fit regions before (left) and after (right) the fit.}
...
\begin{figure}[htbp]
  ...
  \caption{Distributions of \pcbThreeFourSym{} in the 2LOS flavour fit regions before (left) and after (right) the fit.}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lcccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Flavour scale factors for the nominal and alternative \texorpdfstring{$t\bar{t}$+jets}{ttbar+jets} samples.
...
\begin{figure}[htbp]
  ...
  \caption{Illustration of the multivariate kinematic reweighting for \HTSym{} in the 1L channel, shown for the nominal \texorpdfstring{$t\bar{t}$+jets}{ttbar+jets} sample (left) and an alternative generator configuration (right).
  The ratio panels compare data to \texorpdfstring{$t\bar{t}$+jets}{ttbar+jets} prediction after heavy-flavour rescaling (black) and after applying both the flavour and kinematic corrections (red).}
...
\begin{figure}[]
  \centering
  \subfloat[]{\includegraphics[width=0.495\textwidth]{figures/figures_paper/val_ljets_ge8jge3b_HT_all.pdf}}
  \subfloat[]{\includegraphics[width=0.495\textwidth]{figures/figures_paper/val_os2l_ge6jge3b_HT_all.pdf}}\\
  \subfloat[]{\includegraphics[width=0.495\textwidth]{figures/figures_paper/val_ljets_ge8jge3b_nJets.pdf}}
  \subfloat[]{\includegraphics[width=0.495\textwidth]{figures/figures_paper/val_os2l_ge6jge3b_nJets.pdf}}\\
  \subfloat[]{\includegraphics[width=0.495\textwidth]{figures/figures_paper/val_ljets_ge8jge3b_nRCJetsM100.pdf}}
  \subfloat[]{\includegraphics[width=0.495\textwidth]{figures/figures_paper/val_os2l_ge6jge3b_nRCJetsM100.pdf}}
  \caption{
