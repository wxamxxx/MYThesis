The Run~2 search for heavy resonances in $t\bar{t}t\bar{t}$ productions has established competitive constraints on a variety of top-philic new physics scenarios. 
...
The large centre-of-mass energy required to produce four top quarks makes this production particularly sensitive to new particles at the TeV scale. 
...
\begin{table}[htbp]
\centering
\caption{Systematic uncertainty treatment in Scenario~2 (S2) for the extrapolation of the SM \ttttsym{} measurement and the resonance search in the 2LSS/ML channel.}
...
The High-Luminosity LHC (HL-LHC) programme will substantially extend the kinematic reach and statistical precision available for searches for heavy resonances in $t\bar{t}t\bar{t}$ productions. 
...
\subsubsection{Neutral Heavy Resonances (\texorpdfstring{$H/A$}{H/A})}
\label{sec:HL_HA}
...
\caption{Projected 95\% CL upper limits on \sigmaTtHASym{} as a function of \mHASym{} for different integrated luminosities and systematic uncertainty scenarios.}
...
\caption{Projected 95\% CL upper limits on \sigmaTtHASym{} as a function of integrated luminosity for representative resonance masses.}
...
\subsubsection{Top-Philic Scalar Resonances (\texorpdfstring{$S_8$ and $S_1$}{S8 and S1})}
...
\caption{Projected 95\% CL upper limits on \sigmaSEightPairSym{} as a function of \mSEightSym{}.}
...
\sigmaTtSOneSym{} 
as a function of \mSOneSym{} for two representative coupling values.}
...
\caption{Projected 95\% CL exclusion contours in the \mSOneYSOnePlaneSym{} plane under different luminosity and systematic assumptions.}
