...
\begin{figure}[htbp!]
        ...
        Post-fit distributions for the 1L regions obtained from the background-only unblinded data fit at \texorpdfstring{$\boldsymbol{m_H=400}$}{mH=400}~GeV. 
...
\begin{figure}[htbp!]
        ...
        Post-fit distributions for the 2LOS regions obtained from the background-only unblinded data fit at \texorpdfstring{$\boldsymbol{m_H=400}$}{mH=400}~GeV. 
        The fit is performed using all regions (1L+2LOS).}
\end{center}
\end{figure}
...
The fitted pulls and constraints of nuisance parameters in the combined (1L+2LOS) background-only fit are compared across several mass hypotheses in Figure~\ref{fig:unblinded_data_Bonly_NP_mass_all_instrumental} and Figure~\ref{fig:unblinded_data_Bonly_NP_mass_all_modelling}. 
...
\begin{figure}[htbp!]
  ...
  \begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\linewidth]{figures/fits/comparisons/massPoints/GNN/all/data_unblindedBonly/NuisPar_comp_Instrumental_up.pdf}
    \subcaption{Instrumental (part 1)}
    \label{fig:unblinded_data_Bonly_NP_mass_all_instrumental_up}
  \end{subfigure}
  \begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\linewidth]{figures/fits/comparisons/massPoints/GNN/all/data_unblindedBonly/NuisPar_comp_Instrumental_down.pdf}
    \subcaption{Instrumental (part 2)}
    \label{fig:unblinded_data_Bonly_NP_mass_all_instrumental_down}
  \end{subfigure}
  \caption{\label{fig:unblinded_data_Bonly_NP_mass_all_instrumental}
  Fitted pulls and constraints for nuisance parameters on the instrument in the combined (1L+2LOS) background-only unblinded data fit, shown for several mass hypotheses.}
\end{figure}
...
\begin{figure}[htbp!]
  ...
  \end{subfigure}
  \caption{\label{fig:unblinded_data_Bonly_NP_mass_all_modelling}
  Fitted pulls and constraints for nuisance parameters on the theory and modelling in the combined (1L+2LOS) background-only unblinded data fit, shown for several mass hypotheses.}
\end{figure}
...
\begin{figure}[htbp!]
  ...
  Correlation matrix of nuisance parameters in the combined background-only unblinded data fit for \texorpdfstring{$\boldsymbol{m_H=400}$}{mH=400}~GeV.}
\end{figure}
...
\begin{figure}[htbp!]
        ...
        Post-fit distributions for the 1L regions obtained from the unblinded signal-plus-background data fit at \texorpdfstring{$\boldsymbol{m_H=400}$}{mH=400}~GeV. 
        The fit is performed using all regions (1L+2LOS).}
\end{center}
\end{figure}
...
\begin{figure}[htbp!]
        ...
        Post-fit distributions for the 2LOS regions obtained from the unblinded signal-plus-background data fit at \texorpdfstring{$\boldsymbol{m_H=400}$}{mH=400}~GeV. 
        The fit is performed using all regions (1L+2LOS).}
\end{center}
\end{figure}
...
The fitted pulls and constraints of nuisance parameters in the combined (1L+2LOS) fit are compared across mass points in Figure~\ref{fig:unblinded_data_SplusB_NP_mass_all_instrumental} and Figure~\ref{fig:unblinded_data_SplusB_NP_mass_all_modelling}. 
...
\begin{figure}[htbp!]
  \centering
  \begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\linewidth]{figures/fits/comparisons/massPoints/GNN/all/data_unblindedSplusB/NuisPar_comp_Instrumental_up.pdf}
    \subcaption{Instrumental (part 1)}
    \label{fig:unblinded_data_SplusB_NP_mass_all_instrumental_up}
  \end{subfigure}
  \begin{subfigure}[b]{0.44\textwidth}
    \includegraphics[width=\linewidth]{figures/fits/comparisons/massPoints/GNN/all/data_unblindedSplusB/NuisPar_comp_Instrumental_down.pdf}
    \subcaption{Instrumental (part 2)}
    \label{fig:unblinded_data_SplusB_NP_mass_all_instrumental_down}
  \end{subfigure}
  \caption{\label{fig:unblinded_data_SplusB_NP_mass_all_instrumental}
  Fitted pulls and constraints for nuisance parameters on the instrument in the combined (1L+2LOS) signal-plus-background unblinded data fit, shown for several mass hypotheses.}
\end{figure}
...
\begin{figure}[htbp!]
  ...
  \end{subfigure}
  \caption{\label{fig:unblinded_data_SplusB_NP_mass_all_modelling}
  Fitted pulls and constraints for nuisance parameters on the theory and modelling in the combined (1L+2LOS) signal-plus-background unblinded data fit, shown for several mass hypotheses.}
\end{figure}
...
\begin{figure}[htbp!]
  ...
  Correlation matrix of nuisance parameters in the combined signal-plus-background unblinded data fit for \texorpdfstring{$\boldsymbol{m_H=400}$}{mH=400}~GeV.}
\end{figure}
...
The dominant uncertainties arise primarily from the modelling of
$t\bar{t}$ production in association with heavy-flavour jets,
including the comparison between the 4FS and 5FS predictions and
the parton shower modelling in the $t\bar{t}+b\bar{b}$ and $t\bar{t}+\geq3b$ components.
Additional contributions originate from the generator modelling
of SM $t\bar{t}t\bar{t}$ production, the normalisation of
$t\bar{t}+\geq1c$ and $t\bar{t}+\geq1b$ backgrounds,
and the NN-based kinematic corrections applied in the 2LOS channel.
...
\begin{figure}[htbp!]
  ...
  Ranking of nuisance parameters according to their impact on the fitted signal strength \muSym{} for two representative mass points in the combined (1L+2LOS) signal-plus-background unblinded data fit.}
\end{figure}
...
As mentioned in Section~\ref{sec:syst_theory}, the group of uncertainties related to the modelling of the $t\bar{t}+$jets background is the dominant source of systematic uncertainty.
...
\begin{table}[htbp!]
    ...
    The value for each group is obtained by fixing the group of uncertainties to their post-fit values from the
    nominal fit, and taking the quadratic difference between the resulting
    uncertainty in the \sigmaTtHAToTtttSym{} cross-section and the total uncertainty.}
    \end{center}
\end{table}

\subsubsection*{\textbf{Signal strength and significance}}

The goodness-of-fit p-values for the signal-plus-background hypothesis, shown in Fig.~\ref{fig:gof_mass}, range between approximately 0.47 and 0.89 across the mass points. 
This indicates that the fitted model provides an adequate description of the observed data over the full mass range considered.

\begin{figure}[t]
\centering
\includegraphics[width=0.7\textwidth]{figures/GoF_1LOS.pdf}
\caption{
Goodness-of-fit \pValueSym{}-values for the signal-plus-background hypothesis
as a function of the heavy Higgs boson mass.
}
\label{fig:gof_mass}
\end{figure}
...
The observed significances are shown in Figure~\ref{fig:data_SplusB_significance}, and no statistically significant excess is observed.
...
\begin{figure}[htbp!]
  ...
  \begin{subfigure}[t]{0.49\textwidth}
    ...
    Fitted signal strength $\mu$ as a function of the heavy Higgs boson mass.}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.49\textwidth}
    \includegraphics[width=\linewidth]{figures/fits/significanceVsMass.pdf}
    \subcaption{\label{fig:data_SplusB_significance}
    Observed significances as a function of the heavy Higgs boson mass.}
  \end{subfigure}
  \caption{\label{fig:data_SplusB_results}
  Summary of the signal-plus-background fit results as a function of \mHASym{}. 
  The fitted signal strength \muSym{} is shown in the left panel, while the observed significances are shown in the right panel.}
\end{figure}
...
\begin{figure}[htbp!]
  ...
  \caption{
  Observed (solid line) and expected (dashed line) 95\% CL upper limits on the production cross-section times branching ratio,
  \sigmaTtHASym{}, as a function of \mHASym{}.
  The green (yellow) band represents the \pmOneSigmaSym{} (\pmTwoSigmaSym{}) interval around the expected limit.
  Theoretical predictions for two values of \tanBetaSym{} are shown for an \HSym{} boson.
  The corresponding predictions for \ASym{} differ by less than \texorpdfstring{$\boldsymbol{3\,\text{\textperthousand}}$}{3 per mille} for all mass points and \tanBetaSym{} values considered.}
  \label{fig:limits_1LOS}
\end{figure}

These limits are translated into exclusion regions in the $(m_{H/A}, \tan\beta)$ parameter plane of the Type-II 2HDM.
...
The uncertainty in the theoretical cross-sections arises from variations of the PDFs and the renormalisation and factorisation scales.
...
\begin{figure}[htbp!]
  ...
  \caption{
  Observed (red solid) and expected (black dashed) 95\% CL lower limits on \tanBetaSym{}
  as a function of \mHASym{} obtained from the 1L and 2LOS final states,
  assuming a Type-II 2HDM in the alignment limit.
  Values of \tanBetaSym{} below the observed limit are excluded.
  Panel (a) shows the scenario with \mHAEqualSym{}, while panels (b) and (c)
  correspond to the \HSym{}-only and \ASym{}-only scenarios.
  The yellow band indicates the \pmOneSigmaSym{} interval around the expected limit,
  and the red dashed lines show the effect of varying the theoretical cross-sections by \pmOneSigmaSym{}.
  Values of \texorpdfstring{$\boldsymbol{\tan\beta<0.4}$}{tanbeta<0.4} are not considered to maintain perturbativity of the top-quark Yukawa coupling~\cite{Branco:2012}.}
  \label{fig:2D_1LOS}
\end{figure}
...
\subsubsection{Combined interpretation with the 2LSS/ML channel}
\label{sec:limits_combined}

The 1L/2LOS analysis is combined with the ATLAS search in the 2LSS/ML final state using a simultaneous profile likelihood fit across all signal and control regions of both analyses. 
...
For comparison, the expected limits from the individual 1L/2LOS and 2LSS/ML channels are also displayed.

\begin{figure}[htbp!]
    \centering
    \includegraphics[width=0.6\linewidth]{figures/figures_paper/lim_combined_with_individual_exp.pdf}
    \caption{\label{fig:combination_limit_1}
    Observed (solid line) and expected (dashed line) 95\% CL upper limits on the production cross-section times branching ratio,
    \sigmaTtHASym{}, as a function of \mHASym{}.
    The green (yellow) band represents the \pmOneSigmaSym{} (\pmTwoSigmaSym{}) interval around the expected limit.
    Theoretical predictions for two values of \tanBetaSym{} are shown for an \HSym{} boson.
    The expected limits from the individual 1L/2LOS and 2LSS/ML channels are shown for comparison.}
\end{figure}
...
while the 2LSS/ML channel benefits from a lower background environment and reduced contamination from mis-modelled $t\bar{t}$ processes. 
...
\begin{figure}[htbp!]
  ...
  \caption{
  Observed (red solid) and expected (black dashed) 95\% CL lower limits on \tanBetaSym{}
  as a function of \mHASym{} obtained from the 1L/2LOS and 2LSS/ML final states,
  assuming a Type-II 2HDM in the alignment limit.
  Values of \tanBetaSym{} below the observed limit are excluded.
  Panel (a) shows the scenario with \mHAEqualSym{}, while panels (b) and (c)
  correspond to the \HSym{}-only and \ASym{}-only scenarios.
...
\subsection{Interpretation in the \sEighthead{} model}
\label{sec:limits_sgluon}

In addition to the 2HDM interpretation, 
...
\begin{figure}[htbp!]
 ...
 Observed (solid line) and expected (dashed line) 95\% CL upper limits on the cross section for 
 \sEightPairToTtttSym{} production 
 as a function of \mSEightSym{} in the 1L/2LOS (left) and 2LSS/ML (right) final states.
...
\begin{figure}[htbp!]
 ...
 \sEightPairToTtttSym{} production cross section 
 as a function of \mSEightSym{} from the combination of the 1L/2LOS and 2LSS/ML final states. 
 The expected limits from the individual 1L/2LOS and 2LSS/ML channels are shown for comparison.
 The predicted production cross section from Ref.~\cite{Darm__2021} is shown for comparison.}
\end{figure}
...
$S_{8}$ masses up to approximately 1.3~TeV are excluded at 95\% CL.