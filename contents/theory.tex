...
Finally, attention is turned to the top quark, the main focus of this thesis, and to processes involving multiple top quarks, in particular $t\bar{t}t\bar{t}$ production.
...
In multi-top productions, the partonic centre-of-mass energy can reach the 
...
\section{Top Quarks and \tttthead{} Production}
\label{sec:four-tops}
...
Among the multi-top productions accessible at the Large Hadron Collider,
...
Before discussing the mechanisms contributing to $t\bar{t}t\bar{t}$ production,
...
\subsection{\tttthead{} Production in the Standard Model}
...
Despite its rarity, $t\bar{t}t\bar{t}$ production occupies a unique position in collider phenomenology, 
...
At leading order, $t\bar{t}t\bar{t}$ production proceeds predominantly through QCD-mediated processes. 
...
\end{tikzpicture}
\end{subfigure}
\caption{Illustration of Standard Model \ttttsym{} production. The mediator connecting two top quarks can be a gluon, a neutral electroweak gauge boson (\gammasym{} or \Zsym{}), or a Higgs boson.}
...
As a result, $t\bar{t}t\bar{t}$ production provides a complementary probe of the top-Higgs interaction beyond processes such as inclusive $t\bar{t}$ or associated $t\bar{t}H$ production.
...
\subsection{BSM Contributions to \tttthead{} Production}

The $t\bar{t}t\bar{t}$ production is particularly sensitive to new physics scenarios that feature enhanced couplings to the top quark. 
...
Their characteristic contributions to $t\bar{t}t\bar{t}$ production are illustrated in Fig.~\ref{fig:bsm_4top_feynman}.

\paragraph{\tttthead{} production in 2HDM.}
In the 2HDM, the presence of additional heavy neutral Higgs bosons, a CP-even scalar \(H\) and a CP-odd pseudoscalar \(A\), provides new resonant contributions to $t\bar{t}t\bar{t}$ production. 
...
When the heavy scalar mass satisfies \(m_{H/A} > 2m_t\), the decay \(H/A \to t\bar{t}\) becomes dominant, leading to a resonant enhancement of the $t\bar{t}t\bar{t}$ production cross section.

\paragraph{\tttthead{} production via \sEighthead{}.}
...
The pair production process therefore leads to a $t\bar{t}t\bar{t}$ production
...
$t\bar{t}t\bar{t}$ production arises from $S_{8}$ pair production followed by the
...
In contrast to the 2HDM case, where $t\bar{t}t\bar{t}$ production arises from the
...
\caption{BSM contributions to \ttttsym{} production: (left) 2HDM heavy scalar \(H/A\); (right) \sEightsym{} pair decay.}
